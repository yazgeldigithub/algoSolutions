...
not iterable.  If we convert it to a string, we will be able
to iterate over it.
As a string though, we cannot get the power of a string.  We
need to take the variable and turn it into an integer so we
can get the number.
Next, we take that number and turn it back into a string and add
...
n1 = 9119  # returns 811181
n2 = 2483  # returns 416649
print(csSquareAllDigits(n1))
print(csSquareAllDigits(n2))
